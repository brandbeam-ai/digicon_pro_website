...
export const ComparisonTable: React.FC = () => {
  ...
  const rows = [
    { 
      feature: getTranslation(translations, 'vs.row1.feature', "Strategy"), 
      old: getTranslation(translations, 'vs.row1.old', "Hoping for a hit"), 
      new: getTranslation(translations, 'vs.row1.new', "Reducing variance with testing") 
    },
    { 
      feature: getTranslation(translations, 'vs.row2.feature', "Learning"), 
      old: getTranslation(translations, 'vs.row2.old', "Scattered in people's heads"), 
      new: getTranslation(translations, 'vs.row2.new', "Compounding: Validated Creative Plays") 
    },
    { 
      feature: getTranslation(translations, 'vs.row3.feature', "Speed"), 
      old: getTranslation(translations, 'vs.row3.old', "Slow briefing cycles"), 
      new: getTranslation(translations, 'vs.row3.new', "AI‑accelerated execution in days") 
    },
    { 
      feature: getTranslation(translations, 'vs.row4.feature', "Measurement"), 
      old: getTranslation(translations, 'vs.row4.old', "Vanity metrics dominate"), 
      new: getTranslation(translations, 'vs.row4.new', "Scorecards, gates, and rules") 
    },
    { 
      feature: getTranslation(translations, 'vs.row5.feature', "Outcome"), 
      old: getTranslation(translations, 'vs.row5.old', "Awareness without clarity"), 
      new: getTranslation(translations, 'vs.row5.new', "Decision clarity + repeatable winners") 
    },
  ];
    ...
    <section className="pb-24 relative">
      <div className="container mx-auto px-4">
        ...
        <div className="grid md:grid-cols-3 gap-8">
            {[
                {
                    title: getTranslation(translations, 'asset.col1.title', "The Brain"),
                    sub: getTranslation(translations, 'asset.col1.sub', "Decision Intelligence"),
                    icon: Brain,
                    items: [
                      getTranslation(translations, 'asset.col1.item1', "Customer Decision Intelligence Map"),
                      getTranslation(translations, 'asset.col1.item2', "Objection Library + Responses"),
                      getTranslation(translations, 'asset.col1.item3', "Validated Creative Plays Library")
                    ]
                },
                {
                    title: getTranslation(translations, 'asset.col2.title', "The Fuel"),
                    sub: getTranslation(translations, 'asset.col2.sub', "AI-Accelerated Output"),
                    icon: Layers,
                    items: [
                      getTranslation(translations, 'asset.col2.item1', "Monthly conversion-first assets"),
                      getTranslation(translations, 'asset.col2.item2', "Whitelisted access setups"),
                      getTranslation(translations, 'asset.col2.item3', "Unlimited usage rights")
                    ]
                },
                {
                    title: getTranslation(translations, 'asset.col3.title', "The Compass"),
                    sub: getTranslation(translations, 'asset.col3.sub', "Scale Decisions"),
                    icon: Lock,
                    items: [
                      getTranslation(translations, 'asset.col3.item1', "Creative Scorecards"),
                      getTranslation(translations, 'asset.col3.item2', "Weekly Decision Memos"),
                      getTranslation(translations, 'asset.col3.item3', "Profit-focused Signal Reports")
                    ]
                }
            ].map((col, i) => (
